...
HLS_SOURCES = ../../../../testbench.cpp ../../../../snn_implementation.cpp
...
$(ObjDir)/snn_implementation.o: ../../../../snn_implementation.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../snn_implementation.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/snn_implementation.d

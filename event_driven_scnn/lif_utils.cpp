...
//     return (ap_fixed<64,16>) base_decay >> k;
// }
...
//     // V_new = V_old + Input
//     // Não há fator de resistência ou decaimento exponencial.
//     state.v_mem += spike.amplitude;

//     // 2. Atualização de timestamp (apenas para registro)
//     state.last_spike_time = spike.timestamp;
// }
...
//     #pragma HLS INLINE
//     if (state.v_mem >= state.v_th) {
//         // Reset: Pode ser para V_RESET (Hard Reset) ou subtrair V_TH (Soft Reset)
//         state.v_mem = state.v_mem - state.v_th; 
//         state.last_spike_time = spike.timestamp;
//         return true;
//     }
//     return false;

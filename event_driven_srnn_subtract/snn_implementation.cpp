...
//--------------------------------------------------
    ...
    Linear<12,40>(input, layer_1, weights_1);
...
//--------------------------------------------------
	...
	CubaLIF<1,1,40>(layer_1_merged, layer_3, tau_syn_3, tau_mem_3, r_3, v_leak_3, v_threshold_3, v_reset_3, w_in_3);
...
//--------------------------------------------------
	...
	Linear<40,40>(layer_3_split1, layer_2_rec, weights_2_rec); // RESET BY ZERO
...
//--------------------------------------------------
    ...
    Linear<40,7>(layer_3_split2, layer_4, weights_4); // RESET BY ZERO

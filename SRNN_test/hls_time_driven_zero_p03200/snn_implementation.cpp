...
//--------------------------------------------------
	...
	AffineReuse<146>(input, layer_1, weights_1, bias_1);
...
//--------------------------------------------------
	...
	bit_t layer_3[38];
	CubaLIF<dynamics_t,12>(layer_1, layer_3, alpha_syn_3, beta_mem_3, r_3, v_leak_3, v_threshold_3, v_reset_3, w_in_3, u_state_3, v_state_3, reset_potentials, false);

//--------------------------------------------------
// implementation of 'lif1.w_rec' layer
//--------------------------------------------------

	AffineReuse<462>(layer_3, layer_2_rec, weights_2_rec, bias_2_rec);
...
//--------------------------------------------------
	...
	AffineReuse<85>(layer_3, layer_4, weights_4, bias_4);

//--------------------------------------------------
// implementation of 'lif2' layer
//--------------------------------------------------

	CubaLIF<dynamics_t,2>(layer_4, output, alpha_syn_5, beta_mem_5, r_5, v_leak_5, v_threshold_5, v_reset_5, w_in_5, u_state_5, v_state_5, reset_potentials, false);
}

...
{
	#pragma HLS DATAFLOW
	hls::stream<ed_spike_t> edge_2_fc2_to_lif2;
	#pragma HLS STREAM variable=edge_2_fc2_to_lif2 depth=8
	hls::stream<ed_spike_t> edge_4_lif1_lif_to_lif1_w_rec;
	#pragma HLS STREAM variable=edge_4_lif1_lif_to_lif1_w_rec depth=39
	hls::stream<ed_spike_t> edge_5_fc1_to_lif1_lif;
	#pragma HLS STREAM variable=edge_5_fc1_to_lif1_lif depth=39
	hls::stream<ed_spike_t> edge_6_lif1_lif_to_fc2;
	#pragma HLS STREAM variable=edge_6_lif1_lif_to_fc2 depth=39
	hls::stream<ed_spike_t> merge_lif1_lif_0;
	#pragma HLS STREAM variable=merge_lif1_lif_0 depth=39
	hls::stream<ed_spike_t> node_lif1_lif_out;
	#pragma HLS STREAM variable=node_lif1_lif_out depth=39
	AffineSparse<12,38,456>(input_stream, edge_5_fc1_to_lif1_lif, sparse_col_ptr_1, sparse_row_idx_1, sparse_values_1, sparse_bias_1, reset_potentials);
	Merge(edge_5_fc1_to_lif1_lif, feedback_state_0, merge_lif1_lif_0);
	CubaLIFActiveList<1,1,38,2,false>(merge_lif1_lif_0, node_lif1_lif_out, active_u_shifts_2, active_u_terms_2, active_v_shifts_2, active_v_terms_2, v_leak_2, v_threshold_2, v_reset_2, active_input_gain_2, 9.9999999999999995e-07, reset_potentials);
	Split(node_lif1_lif_out, edge_4_lif1_lif_to_lif1_w_rec, edge_6_lif1_lif_to_fc2);
	AffineSparseStep<38,38,1444>(edge_4_lif1_lif_to_lif1_w_rec, feedback_next_0, sparse_col_ptr_3, sparse_row_idx_3, sparse_values_3, sparse_bias_3, reset_potentials);
	AffineSparse<38,7,266>(edge_6_lif1_lif_to_fc2, edge_2_fc2_to_lif2, sparse_col_ptr_4, sparse_row_idx_4, sparse_values_4, sparse_bias_4, reset_potentials);
	CubaLIFActiveList<1,1,7,5,false>(edge_2_fc2_to_lif2, output_stream, active_u_shifts_5, active_u_terms_5, active_v_shifts_5, active_v_terms_5, v_leak_5, v_threshold_5, v_reset_5, active_input_gain_5, 9.9999999999999995e-07, reset_potentials);
}

void snn_to_hls(hls::stream<ed_spike_t>& input_stream, hls::stream<ed_spike_t>& output_stream, bool reset_potentials)
{
	static ed_spike_t feedback_events_0[39];
	...
	#pragma HLS STREAM variable=feedback_next_0 depth=39
	...
	while (!feedback_done_0) {
		...
		if (feedback_next_size_0 < 39) feedback_events_0[feedback_next_size_0++] = feedback_event_0;
